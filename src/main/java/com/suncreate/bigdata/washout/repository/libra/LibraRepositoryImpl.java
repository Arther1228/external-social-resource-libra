...
import com.suncreate.bigdata.washout.utils.BeanUtils;
...
@Repository
public class LibraRepositoryImpl<T, ID> implements LibraBaseRepository<T, ID> {

    private EntityManager entityManager;

    private EntityTransaction transaction;

    @PersistenceUnit(unitName = "libraUnit")
